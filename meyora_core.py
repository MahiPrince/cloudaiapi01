...
FIELD_TOOLS = [
    {"type":"function","name":"work_search","description":"Search the field engineer's C4C work orders/service appointments. Use exact dates derived from device local time; never use a hard-coded demo date.","strict":True,"parameters":{"type":"object","properties":{"query":{"type":["string","null"]},"date":{"type":["string","null"]},"date_from":{"type":["string","null"]},"date_to":{"type":["string","null"]},"status":{"type":["string","null"]},"limit":{"type":"integer","minimum":1,"maximum":100}},"required":["query","date","date_from","date_to","status","limit"],"additionalProperties":False}},
    ...
    {"type":"function","name":"calendar_search","description":"Search the user's Outlook Calendar records by exact date/range or text.","strict":True,"parameters":{"type":"object","properties":{"query":{"type":["string","null"]},"date":{"type":["string","null"]},"date_from":{"type":["string","null"]},"date_to":{"type":["string","null"]},"limit":{"type":"integer","minimum":1,"maximum":100}},"required":["query","date","date_from","date_to","limit"],"additionalProperties":False}},
    {"type":"function","name":"mail_search","description":"Search Outlook mail by person, customer, work order, subject/body or exact date/range.","strict":True,"parameters":{"type":"object","properties":{"query":{"type":["string","null"]},"date":{"type":["string","null"]},"date_from":{"type":["string","null"]},"date_to":{"type":["string","null"]},"unread_only":{"type":"boolean"},"limit":{"type":"integer","minimum":1,"maximum":100}},"required":["query","date","date_from","date_to","unread_only","limit"],"additionalProperties":False}},
    {"type":"function","name":"teams_search","description":"Search Microsoft Teams messages by person/topic/customer/work order or date. For latest message, leave filters null.","strict":True,"parameters":{"type":"object","properties":{"query":{"type":["string","null"]},"date":{"type":["string","null"]},"date_from":{"type":["string","null"]},"date_to":{"type":["string","null"]},"limit":{"type":"integer","minimum":1,"maximum":100}},"required":["query","date","date_from","date_to","limit"],"additionalProperties":False}},
